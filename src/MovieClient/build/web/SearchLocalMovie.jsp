<%-- 
    Document   : SearchLocalMovie
    Created on : Aug 10, 2015, 13:23:44 PM
    Author     : Hugh
--%>
                            ...
                            <article style="position: absolute; width: 100%; opacity: 0;"> 
                                <div class="banner-wrap">
                                    <div class="cont span_2_of_3">
                                        <h1>Search movie from local.</h1>
                                        <div class="search_box">
                                            <form name="Search Movie" method="post" action="LocalMovieServlet">
                                                            ...
                                                            <div class="content-top">
                                                                <div class="section1">
                                                                    <div class="cont1 span_2_of_about">
                                                                        <h3 class="m_1" align="center"><a size="12px">Note: You will find the movie from My Website.</a></h3>
                                                                    </div>
                                                                </div>
