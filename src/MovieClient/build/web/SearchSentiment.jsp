<%-- 
    Document   : SearchSentiment
    Created on : Aug 16, 2015, 17:43:28 PM
    Author     : Hugh
--%>
                                ...
                                <div class="banner-wrap">
                                    <div class="cont span_2_of_3">
                                        ...
                                        <div class="search_box">
                                            <form name="Search Movie" method="post" action="SentimentServlet">
                                                <input name="param1" type="text" value="Movie Name..." onfocus="this.value = '';" onblur="if (this.value == '') {
                                                                               this.value = 'Movie Name...';
                                                            ...
                                                            <div class="content-top">
                                                                <div class="section1">
                                                                    <div class="cont1 span_2_of_about">
                                                                        <h3 class="m_1" align="center"><a size="12px">Note: You will get sentiment analysis results from Viralheat.</a></h3>
                                                                    </div>
                                                                </div>
