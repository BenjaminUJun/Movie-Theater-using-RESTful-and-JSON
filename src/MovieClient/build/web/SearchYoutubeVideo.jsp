<%-- 
    Document   : SearchYoutubeVideo
    Created on : Aug 15, 2015, 18:37:23 PM
    Author     : Hugh
--%>
                                        ...
                                        <div class="box_content_center">
                                            <div class="menu_box_list">
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="MovieIndexInsert.jsp">Add Movie</a></li> 
                                                    <li><a href="SearchLocalMovie.jsp">Local Movie</a></li>
                            ...
                            <article style="position: absolute; width: 100%; opacity: 0;"> 
                                <div class="banner-wrap">
                                    <div class="cont span_2_of_3">
                                        <h1>Search Video from Youtube.</h1>
                                        <div class="search_box">
                                            <form name="Search Movie" method="post" action="YoutubeVideoServlet">
                                                <input name="param1" type="text" value="Video Name..." onfocus="this.value = '';" onblur="if (this.value == '') {
                                                                               this.value = 'Video Name...';
                                                            ...
                                                            <div class="content-top">
                                                                <div class="section1">
                                                                    <div class="cont1 span_2_of_about">
                                                                        <h3 class="m_1" align="center"><a size="12px">Note: You will find the Video from Youtube.</a></h3>
                                                                    </div>
                                                                </div>
