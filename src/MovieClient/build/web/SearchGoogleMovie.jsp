<%-- 
    Document   : SearchGoogleMovie
    Created on : Aug 13, 2015, 12:59:17 PM
    Author     : Hugh
--%>
			   ...
			   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	<div class="banner-wrap">
						<div class="cont span_2_of_3">
						    <h1>Search movie from Google.</h1>
						     <div class="search_box">
								<form name="Search Movie" method="post" action="GoogleMovieServlet">
   	   ...
   	   <div class="main">
   	     <div class="content-top">
				...
				<div class="cont1 span_2_of_about">
					<h3 class="m_1" align="center"><a size="12px">Note: You will find the movie from Douban and IMDB.</a></h3>
		    </div>
   	   	 </div>
